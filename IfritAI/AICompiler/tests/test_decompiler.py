...
class TestAIDecompiler:
    ...
    def decompiler(self):
        ...
        info_stat_data = {'monster_name': bite_bug_text, 'hp': [4, 11, 0, 0], 'str': [30, 5, 6, 130], 'vit': [1, 50, 4, 1], 'mag': [24, 5, 2, 100],
                          ...
                          'byte_flag_0': {'byte0_zz1': 1, 'byte0_zz2': 1, 'byte0_zz3': 0, 'byte0_unused4': 0, 'byte0_unused5': 0, 'byte0_unused6': 0,
                                          'byte0_unused7': 0, 'byte0_unused8': 0},
                          'byte_flag_1': {'Zombie': 0, 'Fly': 1, 'byte1_zz1': 0, 'Immune NVPlus_Moins': 0, 'Hidden HP': 0, 'Auto-Reflect': 0, 'Auto-Shell': 0,
                          ...
                          'byte_flag_2': {'IncreaseSurpriseRNG': 0, 'DecreaseSurpriseRNG': 0, 'SurpriseAttackImmunity': 0, 'IncreaseChanceEscape': 1,
                                          'DecreaseChanceEscape': 0, 'byte2_unused_6': 0, 'Diablos-missed': 0, 'Always obtains card': 0},
                          'byte_flag_3': {'byte3_zz1': 0, 'byte3_zz2': 1, 'byte3_zz3': 1, 'byte3_zz4': 0, 'byte3_unused_5': 0, 'byte3_unused_6': 0,
                                          'byte3_unused_7': 0, 'byte3_unused_8': 0}, 'extra_xp': 5, 'xp': 15,
