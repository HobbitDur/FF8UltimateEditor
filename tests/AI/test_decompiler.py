...
class TestAIDecompiler:
    ...
    def decompiler(self):
        ...
        info_stat_data = {'monster_name': bite_bug_text, 'hp': [4, 11, 0, 0], 'str': [30, 5, 6, 130], 'vit': [1, 50, 4, 1], 'mag': [24, 5, 2, 100],
                          'spr': [1, 6, 2, 1], 'spd': [0, 10, 4, 20], 'eva': [0, 10, 2, 30],
                          'abilities_low': [{'type': 8, 'animation': 12, 'id': 2}, {'type': 8, 'animation': 12, 'id': 2}, {'type': 8, 'animation': 12, 'id': 2},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}],
                          'abilities_med': [{'type': 8, 'animation': 12, 'id': 2}, {'type': 8, 'animation': 13, 'id': 110},
                                            {'type': 8, 'animation': 14, 'id': 111}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                            {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}],
                          'abilities_high': [{'type': 8, 'animation': 12, 'id': 2}, {'type': 8, 'animation': 13, 'id': 110},
                                             {'type': 8, 'animation': 14, 'id': 111}, {'type': 0, 'animation': 0, 'id': 0},
                                             {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                             {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                             {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0},
                                             {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}, {'type': 0, 'animation': 0, 'id': 0}],
                          'med_lvl': 20, 'high_lvl': 30,
                          'byte_flag_0': {'camera_category_bit_0': 1, 'camera_category_bit_1': 1, 'camera_category_bit_2': 0, 'camera_category_bit_3': 0, 'camera_category_unused_5': 0, 'camera_category_unused_6': 0,
                                          'camera_category_unused_7': 0, 'camera_category_unused_8': 0},
                          'byte_flag_1': {'Zombie': 0, 'Fly': 1, 'byte1_unused_3': 0, 'Immune NVPlus_Moins': 0, 'Hidden HP': 0, 'Auto-Reflect': 0, 'Auto-Shell': 0,
                                          'Auto-Protect': 0}, 'card': [2, 2, 56], 'devour': [0, 0, 0],
                          'byte_flag_2': {'IncreaseSurpriseRNG': 0, 'DecreaseSurpriseRNG': 0, 'SurpriseAttackImmunity': 0, 'IncreaseChanceEscape': 1,
                                          'DecreaseChanceEscape': 0, 'byte2_unused_6': 0, 'Gravity Immunity': 0, 'Always obtains card': 0},
                          'byte_flag_3': {'devour_category_bit_0': 0, 'devour_category_bit_1': 1, 'devour_category_bit_2': 1, 'devour_category_bit_3': 0, 'devour_category_unused_5': 0, 'devour_category_unused_6': 0,
                                          'devour_category_unused_7': 0, 'devour_category_unused_8': 0}, 'extra_xp': 5, 'xp': 15,
                          'low_lvl_mag': [{'ID': 1, 'value': 0}, {'ID': 50, 'value': 0}, {'ID': 0, 'value': 0}, {'ID': 0, 'value': 0}],
                          'med_lvl_mag': [{'ID': 2, 'value': 0}, {'ID': 50, 'value': 0}, {'ID': 0, 'value': 0}, {'ID': 0, 'value': 0}],
                          'high_lvl_mag': [{'ID': 2, 'value': 0}, {'ID': 50, 'value': 0}, {'ID': 0, 'value': 0}, {'ID': 0, 'value': 0}],
                          'low_lvl_mug': [{'ID': 109, 'value': 2}, {'ID': 109, 'value': 2}, {'ID': 109, 'value': 2}, {'ID': 109, 'value': 2}],
                          'med_lvl_mug': [{'ID': 110, 'value': 2}, {'ID': 110, 'value': 2}, {'ID': 110, 'value': 2}, {'ID': 110, 'value': 2}],
                          'high_lvl_mug': [{'ID': 111, 'value': 2}, {'ID': 111, 'value': 2}, {'ID': 111, 'value': 2}, {'ID': 111, 'value': 2}],
                          'low_lvl_drop': [{'ID': 109, 'value': 1}, {'ID': 109, 'value': 1}, {'ID': 109, 'value': 2}, {'ID': 109, 'value': 2}],
                          'med_lvl_drop': [{'ID': 109, 'value': 4}, {'ID': 110, 'value': 1}, {'ID': 110, 'value': 2}, {'ID': 110, 'value': 2}],
                          'high_lvl_drop': [{'ID': 111, 'value': 1}, {'ID': 111, 'value': 1}, {'ID': 111, 'value': 2}, {'ID': 111, 'value': 2}],
                          'mug_rate': 50.19607843137255, 'drop_rate': 50.19607843137255, 'padding': 0, 'ap': 1,
                          'renzokuken': [160, 160, 160, 141, 259, 332, 333, 259], 'elem_def': [100, 200, 100, 100, 100, 200, 100, 100],
    ...
    def test_com15_init(self, decompiler: AIDecompiler):
        """Test decompiling if-else statement"""
        bytecode = [14, 220, 0, 14, 221, 0, 2, 3, 0, 5, 58, 0, 28, 0, 2, 3, 0, 4, 60, 0, 17, 0, 2, 7, 200, 1, 10, 0, 6, 0, 14, 222, 1, 35, 0, 0, 35, 0, 0, 35,
                    0, 0, 0, 0]
        code = decompiler.decompile(bytecode)
    ...
    def test_com10_full(self, decompiler: AIDecompiler):
        """Test decompiling if-else statement"""
        bytecode = [2, 14, 200, 0, 0, 0, 6, 0, 40, 2, 5, 35, 0, 0, 2, 2, 4, 0, 0, 0, 4, 0, 0, 35, 0, 0, 2, 4, 200, 0, 30, 0, 8, 0, 4, 207, 12, 0, 0, 35, 0, 0,
                    2, 221, 200, 5, 4, 0, 14, 0, 4, 222, 40, 2, 10, 12, 4, 14, 221, 0, 0, 35, 0, 0, 4, 201, 2, 2, 2, 0, 0, 0, 36, 0, 2, 5, 200, 0, 35, 0, 19, 0,
                    2, 2, 10, 4, 4, 0, 8, 0, 38, 0, 200, 0, 35, 35, 0, 0, 35, 0, 0, 14, 220, 1, 12, 0, 0, 35, 0, 0, 14, 220, 2, 2, 2, 2, 0, 0, 0, 6, 0, 12, 1,
                    0, 35, 0, 0, 12, 2, 0, 0, 0]
        code = decompiler.decompile(bytecode)
