"""Tests for the SeeD-test layout preview logic (Nida/seedfont.py).
...
from Nida.seedfont import (SeedFontMetrics, layout_text, LINE_HEIGHT,
...
def test_all_vanilla_questions_fit_envelope(game_data):
    ...
    manager.load_file(str(MENU_DIR / "mngrp.bin"))
    for _, test in manager.iter_sections():
