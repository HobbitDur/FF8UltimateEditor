...
def main():
    ...
    target_dir = Path(".")
    exe_name = "FF8UltimateEditor.exe" if sys.platform == "win32" else "FF8UltimateEditor"
    patcher_exe = "Patcher.exe" if sys.platform == "win32" else "Patcher"  # Name of the patcher executable to exclude
